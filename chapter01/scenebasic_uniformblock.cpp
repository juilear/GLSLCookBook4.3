...
void SceneBasic_UniformBlock::initUniformBlockBuffer()
{
	...
	// allocate a temporary buffer named blockBuffer to hold the data for our block
    GLubyte * blockBuffer;
	...
	// query for the index of each variable within the block
    GLuint indices[4];
	// This accepts an array of variable names (third argument) and returns the indices of the
	// variables in the array indices(fourth argument).
    glGetUniformIndices(programHandle, 4, names, indices);
    
	// use the indices to query for the offsets
    GLint offset[4];
	// this returns the offset of each variable in the array pointed to by the fifth argument
	// This function can also be used to query for the size and type
	...
	// filling our temporary buffer blockBuffer with the data for the uniforms
