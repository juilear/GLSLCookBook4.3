...
{
	try {
		prog.compileShader("D:/Dependence/resource/OpenSceneGraph-Data/glsl/toon.vert",GLSLShader::VERTEX);
		prog.compileShader("D:/Dependence/resource/OpenSceneGraph-Data/glsl/toon.frag",GLSLShader::FRAGMENT);
    	prog.link();
    	prog.use();
