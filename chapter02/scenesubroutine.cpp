...
void SceneSubroutine::render()
{
	...
	// Function:query for the index of each subroutine function
	// parameter1:The first argument is the program handle
	// parameter2:the shader stage
	// parameter3:the name of the subroutine
	...
	// set the value of the subroutine uniform shadeModel
	// This function is designed for setting multiple subroutine uniforms at once
	// The first argument is the shader stage
	// the second is the number of uniforms being set
	// the third is a pointer to an array of subroutine function indexes
