...
{
  private:
	int  handle;    // the OpenGL shader program object
	bool linked;    // indicate whether or not the program has been successfully linked
	std::map<string, int> uniformLocations; // store uniform locations as they are discovered
