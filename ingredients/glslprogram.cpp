...
/*
It checks the map uniformLocations first, and if the location is not found,
queries OpenGL for the location, and stores the result in the map before returning.
*/
...
// The fileExists function is used by compileShaderFromFile to check for file existence.
